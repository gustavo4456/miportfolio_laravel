                ...
                <nav class="tm-nav">
                    ...
                    <div>
                        <div class="tm-brand-box">
                            <h1 class="tm-brand">
                                {{$personas[0]->apellido}} {{$personas[0]->nombre}}
                            </h1>
                        </div>
                        <ul id="tm-main-nav">
                            <li class="nav-item">
            ...
            <div class="tm-main">
                        ...
                        <div class="row">
                            <div class="col-lg-6 tm-col-home mb-4">
                                <div class="tm-text-container">
                                    ...
                                    <p>
                                        {{$personas[0]->presentacion_principal}}
                                    </p>
                                    <p>
                                        {{$personas[0]->presentacion_secundaria}}
                                    </p>
                                </div>
                            </div>
                            <div class="col-lg-6 tm-col-home mb-4">
                ...
                <div class="tm-section-wrap">
                    ...
                    <section id="about" class="tm-section">
                        ...
                        <h3 class="mb-4 tm-text-primary" id="proyectos"><u>Mis proyectos</u></h3>
                        <div class="mt-5" id="mis-proyectos">

                            <!-- <div class="tm-carousel" >
                                <div class="tm-carousel-item">
                                    <figure class="effect-honey mb-4">
                                        <img src="img/mis-proyectos/front-end-mi_pagina.png" alt="Featured Item">
                                        <figcaption>
                                            <ul class="tm-social">
                                                <li><a href="https://github.com/gustavo4456/miportfolio_front_end" class="tm-social-link"><i class="fab fa-github"></i></a></li>
                                            </ul>
                                        </figcaption>
                                    </figure>
                                    <div class="tm-about-text">
                                        <h3 class="mb-3 tm-text-primary tm-about-title">Mi pagina web</h3>
                                        <p>Es la parte del front-end de mi pagina web.</p>
                                        <h4 class="tm-text-secondary tm-about-subtitle">html, css y Javascript</h4>
                                    </div>
                                </div>
                                <div class="tm-carousel-item">
                                    <figure class="effect-honey mb-4">
                                        <img src="img/mis-proyectos/back-end-api-mi-pagina.png" alt="Featured Item">
                                        <figcaption>
                                            <ul class="tm-social">
                                                <li><a href="https://github.com/gustavo4456/miportfolio_api" class="tm-social-link"><i class="fab fa-github"></i></a></li>
                                            </ul>
                                        </figcaption>
                                    </figure>
                                    <div class="tm-about-text">
                                        <h3 class="mb-3 tm-text-primary tm-about-title">API para mi web</h3>
                                        <p>Back-end api para obtener los datos usados en mi pagina web.</p>
                                        <h4 class="tm-text-secondary tm-about-subtitle">Java, Spring Boot</h4>
                                    </div>
                                </div> -->
                        </div>
                </div>
